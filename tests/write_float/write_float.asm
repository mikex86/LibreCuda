...
.text.write_float_sum:
        ...
        /*0010*/                   MOV R2, c[0x4][0x0] ;
        /*0020*/                   ULDC.64 UR4, c[0x0][0x118] ;
        /*0030*/                   MOV R3, c[0x4][0x4] ;
        /*0040*/                   LDG.E R2, [R2.64] ;
        /*0050*/                   ULDC.U16 UR6, c[0x0][0x168] ;
        /*0060*/                   MOV R4, c[0x0][0x160] ;
        /*0070*/                   I2F.S16 R0, UR6 ;
        /*0080*/                   MOV R5, c[0x0][0x164] ;
        /*0090*/                   FADD R0, R0, c[0x0][0x16c] ;
        /*00a0*/                   I2F R7, R2 ;
        /*00b0*/                   FADD R7, R0, R7 ;
        /*00c0*/                   STG.E [R4.64], R7 ;
        /*00d0*/                   EXIT ;
...
//--------------------- .nv.global.init           --------------------------
	...
	.size		global_int,(.L_0 - global_int)
global_int:
.nv.global.init:
        /*0000*/ 	.byte	0x69, 0x00, 0x00, 0x00
.L_0:
